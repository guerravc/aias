...
- Comments remain valid for intentional tracker communications such as `/enrich --brief` brief comments or `/publish` closure notices with remote knowledge links.
